...
export const AboutMe = () => {
    return (
        <section className="py-24 bg-gradient-to-b from-light-yellow via-blush to-blush px-6 md:px-16">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                ...
                >
                    <div className="relative">
                        ...
                        />
                        <div className="absolute -bottom-6 -right-6 w-full h-full rounded-3xl bg-blush-dark/20 -z-10"></div>
                    </div>
                </motion.div>
